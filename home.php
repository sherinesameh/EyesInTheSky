...
<head>
  ...
  <script type="text/javascript">
   $(document).ready(function(){
    ...
    $.post("controller/getInfo.php",
    {
      x: 1
    },function(data,status){
      var info = JSON.parse(data);
      var prof = document.getElementById("profile");
      prof.innerHTML +="<p><span style=\"color : black;text-align:center;font-size : 20px;\">"+info[0].Fname+" "+info[0].Lname+"</strong></p><img src='images/"+info[0].image + "' class=\"img\" height=\"300\" width=\"230\" alt=\"Avatar\">";     

      var x = document.getElementById("info");
      x.innerHTML +="<p style=\"text-align:left;\"><span style = \"color:darkblue; font : bold;\">Email: </span>"+info[0].Email+"</p><p style=\"text-align:left;\"><span style = \"color:darkblue ; font : bold;\">Phone:</br> </span>"+info[0].Phone_num+"</p><p style=\"text-align:left;\"><span style = \"color:darkblue; font : bold;\">Join date:</br></span>"+info[0].Join_Date+"</p>";   

    });

    $.post("controller/getLog.php",
    {
      x: 1
    },function(data,status){
    ...
    $('#test3').on('click','a',function(event){
      ...
      if ($target == "t1") {
       ...
       if ($target == "t2") {
        $.post("controller/getRp.php",
        {
          ...
          Rp.innerHTML ="";
          for (var i = info1.length - 1; i >= 0; i--) {
            Rp.innerHTML += "<tr> <td>"+info1[i].Mac+"</td> <td>"+info1[i].Generation+"</td> <td><a target=\"_blank\" href=\""+info1[i].Location+"\">see location </a></td> <td>"+info1[i].Temperature+" &deg;C</td> <td>"+info1[i].CpuUsage+" %</td> <td>"+info1[i].FreeStorage+" MB</td></tr>";
        ...
        $.post("controller/getProcs.php",
        {
          ...
          Proc.innerHTML ="";
          for (var i = info1.length - 1; i >= 0; i--) {
            Proc.innerHTML += "<tr> <td>"+info1[i].Mac+"</td> <td>"+info1[i].procs+"</td> <td>   <a  href=\"\" id = \""+info1[i].Mac+"\"class=\"material-icons\">pause</a><td> <a  href=\"\" id = \""+info1[i].Mac+"\"class=\"material-icons\">replay</a><td><a  href=\"\" id = \""+info1[i].Mac+"\"class=\"material-icons\">power_settings_new</a></td></tr>";
...
<body>
  ...
  <div class="row">
    ...
    <a class="waves-effect waves-light btn-large" style="margin-bottom: 5px;width: 250px;"><i class="material-icons left">not_interested
    </i>remove admin</a>
  </br>
