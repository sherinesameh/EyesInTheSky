...
--
-- Host: localhost
-- Generation Time: Jun 22, 2017 at 06:34 PM
...
INSERT INTO `Current_Specs` (`Mac`, `FreeStorage`, `CpuUsage`, `Temperature`, `State`, `RamUsage`) VALUES
('255.255.170', 512, 45, 31, 22894, 0),
('255.255.203', 900, 56, 20, 22198, 0),
('255.255.255', 190, 79, 34, 22894, 0),
('255.255.255.1', 2048, 50, 30, 22894, 0),
('255.255.255.10', 4120, 48, 49, 22894, 0),
('255.255.255.11', 2048, 50, 47, 22894, 0),
('255.255.255.12', 2048, 35, 29, 22894, 0),
('255.255.255.13', 6031, 40, 36, 22894, 0),
('255.255.255.14', 2048, 73, 64, 22894, 0),
('255.255.255.15', 2048, 80, 69, 22894, 0),
('255.255.255.16', 2048, 58, 44, 22894, 0),
('255.255.255.17', 2048, 60, 52, 22894, 0),
('255.255.255.18', 2048, 50, 30, 22894, 0),
('255.255.255.2', 2048, 35, 26, 22894, 0),
('255.255.255.3', 2048, 50, 45, 22894, 0),
('255.255.255.4', 2048, 50, 37, 22894, 0),
('255.255.255.6', 2048, 85, 74, 22894, 0),
('255.255.255.7', 2048, 35, 39, 22894, 0),
('255.255.255.8', 2048, 26, 54, 22894, 0),
('255.255.255.9', 3540, 60, 51, 22894, 0),
('b8:27:eb:8d:24:80', 8000, 0, 10, 22894, 0),
('b8:27:eb:f5:d6:1c', 50, 1, 50, 22894, 650);
...
CREATE TABLE `Rp_Specs` (
  ...
  `password` varchar(30) NOT NULL,
  `private_ip` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `Rp_Specs` (`Mac`, `Ram`, `Storage`, `HasCamera`, `Generation`, `Location`, `username`, `password`, `private_ip`) VALUES
('255.255.170', 2048, 2048, 1, 'X-25-200', 'https://www.google.com/maps/place/Alexandria,+Alexandria+Governorate,+Egypt/@22.1260852,-0.3200858,3z/data=!4m8!1m2!2m1!1syour+query!3m4!1s0x14f5c49126710fd3:0xb4e0cda629ee6bb9!8m2!3d31.199881!4d29.9185181', 'pi', 'not real', '192.168.8.100'),
('255.255.203', 1024, 2048, 1, 'X-25-125', 'https://www.google.com/maps/place/Alexandria,+Alexandria+Governorate,+Egypt/@22.1260852,-0.3200858,3z/data=!4m8!1m2!2m1!1syour+query!3m4!1s0x14f5c49126710fd3:0xb4e0cda629ee6bb9!8m2!3d31.199881!4d29.9185181', 'pi', 'not real', '192.168.8.100'),
('255.255.255', 1024, 1024, 1, 'X-25-122', 'https://www.google.com/maps/place/Alexandria,+Alexandria+Governorate,+Egypt/@22.1260852,-0.3200858,3z/data=!4m8!1m2!2m1!1syour+query!3m4!1s0x14f5c49126710fd3:0xb4e0cda629ee6bb9!8m2!3d31.199881!4d29.9185181', 'pi', 'not real', '192.168.8.100'),
('255.255.255.1', 1024, 16384, 0, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.10', 1024, 8192, 1, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.11', 1024, 8192, 0, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.12', 512, 16384, 1, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.13', 1024, 16384, 0, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.14', 1024, 16384, 1, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.15', 1024, 8192, 0, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.16', 512, 8192, 1, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.17', 1024, 16384, 0, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.18', 1024, 16384, 1, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.2', 1024, 16384, 1, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.3', 1024, 8192, 0, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.4', 1024, 16384, 1, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.6', 1024, 8192, 1, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.7', 1024, 16384, 0, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.8', 512, 16384, 1, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('255.255.255.9', 1024, 16384, 0, '3', 'not now', 'pi', 'not real', '192.168.8.100'),
('b8:27:eb:8d:24:80', 3000, 18000, 0, '1', 'not now', 'pi', '123123', '192.1'),
('b8:27:eb:f5:d6:1c', 2048, 16384, 0, '3', 'NOT NOW', 'pi', 'pi123123', '192.168.8.100');
